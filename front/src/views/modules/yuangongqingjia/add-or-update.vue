    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="请假缘由" prop="yuangongqingjiaText">
                        <el-input type="textarea"  :readonly="ro.yuangongqingjiaText" v-model="ruleForm.yuangongqingjiaText" placeholder="请假缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yuangongqingjiaText" label="请假缘由" prop="yuangongqingjiaText">
                            <span v-html="ruleForm.yuangongqingjiaText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="请假类型" prop="yuangongqingjiaTypes">
                        <el-select v-model="ruleForm.yuangongqingjiaTypes" :disabled="ro.yuangongqingjiaTypes" placeholder="请选择请假类型">
                            <el-option
                                v-for="(item,index) in yuangongqingjiaTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="请假类型" prop="yuangongqingjiaValue">
                        <el-input v-model="ruleForm.yuangongqingjiaValue"
                            placeholder="请假类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.yuangongqingjiaTime"  class="input" label="请假时间" prop="yuangongqingjiaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yuangongqingjiaTime"
                                type="datetime"
                                placeholder="请假时间"
                                :disabled="ro.yuangongqingjiaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yuangongqingjiaTime" label="请假时间" prop="yuangongqingjiaTime">
                            <span v-html="ruleForm.yuangongqingjiaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假天数" prop="yuangongqingjiaNumber">
                       <el-input v-model="ruleForm.yuangongqingjiaNumber"
                                 placeholder="请假天数" clearable  :readonly="ro.yuangongqingjiaNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="请假天数" prop="yuangongqingjiaNumber">
                           <el-input v-model="ruleForm.yuangongqingjiaNumber"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yuangongqingjiaYesnoTypes" label="申请状态" prop="yuangongqingjiaYesnoTypes">
                        <el-input v-model="ruleForm.yuangongqingjiaYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yuangongqingjiaYesnoText" label="处理意见" prop="yuangongqingjiaYesnoText">
                        <span v-html="ruleForm.yuangongqingjiaYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yuangongqingjiaShenheTime" label="审核时间" prop="yuangongqingjiaShenheTime">
                        <span v-html="ruleForm.yuangongqingjiaShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yuangongId: false,
                    yuangongqingjiaText: false,
                    yuangongqingjiaTypes: false,
                    insertTime: false,
                    yuangongqingjiaTime: false,
                    yuangongqingjiaNumber: false,
                    yuangongqingjiaYesnoTypes: false,
                    yuangongqingjiaYesnoText: false,
                    yuangongqingjiaShenheTime: false,
                },
                ruleForm: {
                    yuangongId: '',
                    yuangongqingjiaText: '',
                    yuangongqingjiaTypes: '',
                    insertTime: '',
                    yuangongqingjiaTime: '',
                    yuangongqingjiaNumber: '',
                    yuangongqingjiaYesnoTypes: '',
                    yuangongqingjiaYesnoText: '',
                    yuangongqingjiaShenheTime: '',
                },
                yuangongqingjiaTypesOptions : [],
                yuangongqingjiaYesnoTypesOptions : [],
                yuangongOptions : [],
                rules: {
                   yuangongId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuangongqingjia_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yuangongqingjiaTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuangongqingjia_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yuangongqingjiaYesnoTypesOptions = data.data.list;
                    }
                });
