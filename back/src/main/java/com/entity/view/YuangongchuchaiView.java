...
public class YuangongchuchaiView extends YuangongchuchaiEntity implements Serializable {
	...
	* 出差类型的值
	*/
	@ColumnInfo(comment="出差类型的字典表值",type="varchar(200)")
	private String yuangongchuchaiValue;
	/**
	* 交通工具的值
	*/
	@ColumnInfo(comment="交通工具的字典表值",type="varchar(200)")
	private String yuangongchuchaiJiaotonggongjuValue;
	/**
	* 申请状态的值
	*/
	@ColumnInfo(comment="申请状态的字典表值",type="varchar(200)")
	private String yuangongchuchaiYesnoValue;
	...
	* 获取： 出差类型的值
	*/
	public String getYuangongchuchaiValue() {
		return yuangongchuchaiValue;
	}
	/**
	* 设置： 出差类型的值
	*/
	public void setYuangongchuchaiValue(String yuangongchuchaiValue) {
		this.yuangongchuchaiValue = yuangongchuchaiValue;
	}
	//当前表的
	/**
	* 获取： 交通工具的值
	*/
	public String getYuangongchuchaiJiaotonggongjuValue() {
		return yuangongchuchaiJiaotonggongjuValue;
	}
	/**
	* 设置： 交通工具的值
	*/
	public void setYuangongchuchaiJiaotonggongjuValue(String yuangongchuchaiJiaotonggongjuValue) {
		this.yuangongchuchaiJiaotonggongjuValue = yuangongchuchaiJiaotonggongjuValue;
	}
	//当前表的
	/**
	* 获取： 申请状态的值
	*/
	public String getYuangongchuchaiYesnoValue() {
		return yuangongchuchaiYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setYuangongchuchaiYesnoValue(String yuangongchuchaiYesnoValue) {
		this.yuangongchuchaiYesnoValue = yuangongchuchaiYesnoValue;
	}
	...
	public String toString() {
		return "YuangongchuchaiView{" +
			", yuangongchuchaiValue=" + yuangongchuchaiValue +
			", yuangongchuchaiJiaotonggongjuValue=" + yuangongchuchaiJiaotonggongjuValue +
			", yuangongchuchaiYesnoValue=" + yuangongchuchaiYesnoValue +
