...
public class YuangongqingjiaView extends YuangongqingjiaEntity implements Serializable {
	...
	*/
	...
	private String yuangongqingjiaValue;
	/**
	* 申请状态的值
	*/
	@ColumnInfo(comment="申请状态的字典表值",type="varchar(200)")
	private String yuangongqingjiaYesnoValue;
	...
	* 获取： 请假类型的值
	*/
	public String getYuangongqingjiaValue() {
		return yuangongqingjiaValue;
	}
	/**
	* 设置： 请假类型的值
	*/
	public void setYuangongqingjiaValue(String yuangongqingjiaValue) {
		this.yuangongqingjiaValue = yuangongqingjiaValue;
	}
	//当前表的
	/**
	* 获取： 申请状态的值
	*/
	public String getYuangongqingjiaYesnoValue() {
		return yuangongqingjiaYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setYuangongqingjiaYesnoValue(String yuangongqingjiaYesnoValue) {
		this.yuangongqingjiaYesnoValue = yuangongqingjiaYesnoValue;
	}
	...
	public String toString() {
		return "YuangongqingjiaView{" +
			", yuangongqingjiaValue=" + yuangongqingjiaValue +
			", yuangongqingjiaYesnoValue=" + yuangongqingjiaYesnoValue +
