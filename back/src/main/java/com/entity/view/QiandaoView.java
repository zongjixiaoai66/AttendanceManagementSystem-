...
public class QiandaoView extends QiandaoEntity implements Serializable {
	...
	* 上班签到状态的值
	*/
	@ColumnInfo(comment="上班签到状态的字典表值",type="varchar(200)")
	private String qiandaoShangbanValue;
	/**
	* 下班签退状态的值
	*/
	@ColumnInfo(comment="下班签退状态的字典表值",type="varchar(200)")
	private String qiandaoXiabanValue;
	...
	* 获取： 上班签到状态的值
	*/
	public String getQiandaoShangbanValue() {
		return qiandaoShangbanValue;
	}
	/**
	* 设置： 上班签到状态的值
	*/
	public void setQiandaoShangbanValue(String qiandaoShangbanValue) {
		this.qiandaoShangbanValue = qiandaoShangbanValue;
	}
	//当前表的
	/**
	* 获取： 下班签退状态的值
	*/
	public String getQiandaoXiabanValue() {
		return qiandaoXiabanValue;
	}
	/**
	* 设置： 下班签退状态的值
	*/
	public void setQiandaoXiabanValue(String qiandaoXiabanValue) {
		this.qiandaoXiabanValue = qiandaoXiabanValue;
	}
	...
	public String toString() {
		return "QiandaoView{" +
			", qiandaoShangbanValue=" + qiandaoShangbanValue +
			", qiandaoXiabanValue=" + qiandaoXiabanValue +
