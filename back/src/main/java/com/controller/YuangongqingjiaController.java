...
//        else if("员工".equals(role))
//            yuangongqingjia.setYuangongId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(yuangongqingjia.getYuangongqingjiaText()) || "null".equals(yuangongqingjia.getYuangongqingjiaText())){
                yuangongqingjia.setYuangongqingjiaText(null);
        }
        if("".equals(yuangongqingjia.getYuangongqingjiaYesnoText()) || "null".equals(yuangongqingjia.getYuangongqingjiaYesnoText())){
                yuangongqingjia.setYuangongqingjiaYesnoText(null);
        }
